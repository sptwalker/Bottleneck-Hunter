...
| P2-4 | 质量门禁、审计报表、回滚与部署验收 | ⬜ | 全部 | CI/部署脚本、docs | 快/全量测试、ruff、迁移演练、验收清单 | 门禁失败阻止发布，回滚步骤经演练 | 使用上一稳定镜像/提交 |
